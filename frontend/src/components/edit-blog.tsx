...
export const Edit = () => {
    ...
    if (loading || !blog) {
        return (
            <div className="flex justify-center items-center h-screen absolute inset-0 w-screen bg-white bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]">
    ...
    return (
        <div className="absolute inset-0 min-h-screen max-h-fit max-w-screen bg-white bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]">
            ...
            <div className="max-w-screen-lg w-full flex flex-col gap-5">
                ...
                }} type="text" className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" placeholder={blog.title} />
                </div>
                ...
                }} className="h-48bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder={blog.content}  />
                </div>
